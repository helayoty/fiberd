...
// Package hyperlight is the Hyperlight backend through a helper process;
// it needs Linux. Elsewhere it opens as a backend that refuses every
// call.
package hyperlight
...
func (unsupported) Name() string    { return "hyperlight" }
